...
| The next safe hardware proof is a minimal Rocket `MM_I8 -> SILU_I8` **single job / two-task PC-chain** with exact CPU oracle. Only after that should FFN expand toward `up -> EWMUL -> down`. | C3 | T |
