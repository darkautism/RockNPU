...
def main():
    ...
    try:
        ...
        for name,port in (('gpu',a.gpu_port),('npu',a.npu_port),('oracle',a.oracle_port)):
            for i in range(a.warmups): request(port,payload,a.output/'warmup'/f'{name}-{i+1:02d}')
